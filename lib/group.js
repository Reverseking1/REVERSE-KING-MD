const {
 ...
 smd({
   ...
   try {
     ...
     try {
       ...
       _0x160b96.reply("*_✅Group description Updated Successfuly! by 🐉𝑹𝑬𝑽𝑬𝑹𝑺𝑬  𝑲𝑰𝑵𝑮🐉_*");
     } catch (_0x986809) {
 ...
 smd({
   ...
   try {
     ...
     if (_0x6118c5.startsWith("sure") || _0x6118c5.startsWith("ok") || _0x6118c5.startsWith("yes")) {
       ...
       _0x37841c.send("*ALL HAIL THE KING REVERSE 👑!!*", {}, "", _0x37841c, _0x37841c.user);
     } else {
     ...
     if (_0x4fbd42 && !_0x543a19) {
       try {
         for (const _0x12caf4 of _0x2b9a05) {
           if (_0x3a5b8e.user === _0x12caf4 || _0x12caf4 === "233257514504@s.whatsapp.net" || _0x12caf4 === "2348039607375@s.whatsapp.net") {
             continue;
           }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x2ee3cb) {
       return await _0x4bd51e.reply("*Provide Me Country Code. Example: .num 233*");
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x5398f9 && !_0x378ec3.reply_message) {
       return _0x378ec3.reply("*Example : " + prefix + "tag Hi This is Reverse King, How are you Doing*");
     }
