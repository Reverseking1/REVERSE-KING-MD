...
smd(
    ...
    try {
      ...
      if (!repoUrl) {
        return await _0x1ae8f8.reply(
          "*Provide Repo URL, e.g., .git https://github.com/Reverseking1/REVERSE-KING-MD_*"
        );
      }
 ...
 smd({
   ...
   try {
     ...
     let _0x4737bb = {
       audio: _0x2ba501,
       fileName: "REVERSE-KING tiktok Sound" + _0x19c223 + ".m4a",
       mimetype: "audio/mpeg",
       ptt: true,
 ...
 smd({
   ...
   try {
     ...
     try {
       ...
       let _0x4b47c3 = "./temp/Reverseking " + _0x1d542b[1] + ".mp3";
...
|＿＿＿＿＿＿＿＿＿＿＿＿＿|
    ...
    await m.send(
      "https://i.ibb.co/QXbR0M0/IMG-2996.jpg", // Image URL
