  ...
  try {
    ...
    await _0x4e7c63.bot.relayMessage(_0x4e7c63.chat, {
      requestPaymentMessage: {
        ...
        requestFrom: "233257514504@s.whatsapp.net",
        noteMessage: {
          extendedTextMessage: {
            text: _0x50f17a,
            contextInfo: {
...
smd({
  ...
  try {
    if (!_0x23f786) {
      return await _0xe6d6e.reply("Hi This Is Reverse King!!! *" + _0xe6d6e.senderName + "*, do you want to talk?");
    }
    const _0x55bb61 = {
      method: "POST",
      headers: {
...
smd({
  ...
  try {
    ...
    if (!_0x587b99) {
      return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss https://github.com/Reverseking1/REVERSE-KING-MD*");
    }
